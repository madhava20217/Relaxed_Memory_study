...
for freq in "${FREQS[@]}"; do
    ...
    (trap 'kill 0' SIGINT; taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 1 -r $ITERS -o ./results/${freq}/results_1.csv & taskset -c 63 ../Energy_metrics/cpu_monitoring > ./results/${freq}/power_1.csv)
    (trap 'kill 0' SIGINT; taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 1 -r $ITERS -o ./results/${freq}/results_8.csv & taskset -c 63 ../Energy_metrics/cpu_monitoring > ./results/${freq}/power_8.c)
    (trap 'kill 0' SIGINT; taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 1 -r $ITERS -o ./results/${freq}/results_16.csv & taskset -c 63 ../Energy_metrics/cpu_monitoring > ./results/${freq}/power_16.csv)
    (trap 'kill 0' SIGINT; taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 1 -r $ITERS -o ./results/${freq}/results_24.csv & taskset -c 63 ../Energy_metrics/cpu_monitoring > ./results/${freq}/power_24.csv)
    (trap 'kill 0' SIGINT; taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 1 -r $ITERS -o ./results/${freq}/results_32.csv & taskset -c 63 ../Energy_metrics/cpu_monitoring > ./results/${freq}/power_32.csv)

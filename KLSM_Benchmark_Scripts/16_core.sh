...
for freq in "${FREQS[@]}"; do
    ...
    taskset -c 0-23 ./bench.py -a klsm128,klsm256 -p 24 -r $ITERS -o ./results/${freq}/results_24.csv & sudo taskset -c 32 ../Energy_metrics/cpu_monitoring ./results/${freq}/power_24.csv 

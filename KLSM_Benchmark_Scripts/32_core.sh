...
for freq in "${FREQS[@]}"; do
    ...
    taskset -c 0-31 ./bench.py -a klsm128,klsm256 -p 32 -r $ITERS -o ./results/${freq}/results_32.csv & sudo taskset -c 32 ../Energy_metrics/cpu_monitoring ./results/${freq}/power_32.csv 
